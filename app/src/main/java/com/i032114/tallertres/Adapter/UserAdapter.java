...
import com.i032114.tallertres.User;
...
public class UserAdapter extends RecyclerView.Adapter<UserAdapter.ViewHolder>{
    ...
    List<UserModels> Modellist= new ArrayList<>();
    Context context;


    public UserAdapter(List<UserModels> modellist, Context context) {
        Modellist = modellist;
    ...
    public ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        View item = LayoutInflater.from(parent.getContext()).inflate(R.layout.activity_user, parent, false);
    ...
    public class ViewHolder extends RecyclerView.ViewHolder implements View.OnClickListener{
        ...
        public void onClick(View view) {
            ...
            Intent inten = new Intent(contextitem,User.class);
